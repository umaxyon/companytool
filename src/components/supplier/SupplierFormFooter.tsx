...
import { deleteData } from './module/SupplierDataModule';
import { preUpdate } from './module/SupplierFormModule';


class SupplierFormFooter extends React.Component<any, any> {
    ...
    public doDelete() {
        const dataId = this.props.data.partner_id;
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(SupplierFormFooter));
